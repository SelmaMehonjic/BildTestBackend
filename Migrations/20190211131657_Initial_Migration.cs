        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceTypes_DeviceTypes_ParentTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceTypesProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceTypesProperties_DeviceTypes_DeviceTypeId",
                        column: x => x.DeviceTypeId,
                        principalTable: "DeviceTypes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DevicePropertyValues_DeviceTypesProperties_DeviceTypePropertyId",
                        column: x => x.DeviceTypePropertyId,
                        principalTable: "DeviceTypesProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceTypes_ParentTypeId",
                table: "DeviceTypes",
                column: "ParentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceTypesProperties_DeviceTypeId",
                table: "DeviceTypesProperties",
                column: "DeviceTypeId");
        }
